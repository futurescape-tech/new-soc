...
// Component Imports
import DirectionalIcon from '@components/DirectionIcon'
        ...
        <CardContent className='p-6 sm:!p-12'>
          ...
          <div className='flex flex-col gap-5'>
            <Typography className='mbs-1'>
              Enter your passkey, email or mobile number and we will send you instructions to reset your password
            </Typography>
